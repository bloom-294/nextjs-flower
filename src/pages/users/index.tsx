      ...
      <div className="container flex flex-wrap justify-center items-center mx-auto py-5 px-5 bg-white-100 my-12">
        <form className="bg-gray-50 p-4 rounded-xl">
          ...
          <div className="items-center justify-center flex flex-wrap my-4  ">
            <button
              type="button"
              className="text-white px-14 py-2 rounded-md text-sm mr-7 mt-5"
              style={{
                backgroundColor: "#75ad9d",
                border: "solid 1px #75ad9d",
              }}
              onClick={register}
            >
              登録
            ...
            <button
              type="reset"
              className="text-gray-900 px-10 py-2 rounded-md text-sm mt-5"
              style={{ color: "#75ad9d", border: "solid 1px #75ad9d" }}
              onClick={clear}
            >
              クリア
            </button>
