    ...
    <>
      ...
      <div className="mb-7">
        <div className=" flex flex-wrap justify-center items-center mt-7">
          <h1 className="text-bold text-[#75ad9d] text-[30px]" >ショッピングカート</h1>
        </div>
        <div className="container flex flex-col justify-center items-center mx-auto py-5 px-5 ">

          <ShoppingList  pageName="ショッピングカート" />

          <button className="bg-[#75ad9d] text-white rounded-lg py-4  m-4  w-[70%] sm:w-[450px] md:w-[500px] xl:w-[600px] 2xl:w-[600px] shadow-lg" 
          type="button"
